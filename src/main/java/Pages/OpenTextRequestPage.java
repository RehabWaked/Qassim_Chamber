...
public class OpenTextRequestPage extends PageBase{

	public OpenTextRequestPage(WebDriver driver) {
		super(driver);
	...
	public void createNewRequest_OpenTextRequest(String notes, String openRequestText, String otp) throws InterruptedException {
		
		setTextElementText(notesTXT, notes);
		Thread.sleep(1000);
		setTextElementText(openRequestTextTXT, openRequestText);	
		Thread.sleep(1000);
		scrollToTheMiddle();
		Thread.sleep(1000);
	...
	public void createNewRequest_OpenTextRequestWithoutData() throws InterruptedException {
