...
public class MunicipalityServicesRequestPage extends PageBase{

	public MunicipalityServicesRequestPage(WebDriver driver) {
		super(driver);
	...
	//Definition 
		...
		@FindBy (css = ".sp-details-page div:nth-of-type(2) li:nth-of-type(1)")
		...
		@FindBy (css = ".sp-details-page div:nth-of-type(2) li:nth-of-type(2)")
		...
		@FindBy (css=".sp-details-page li:nth-of-type(4)")
		...
		public void CreateNewMunicipalityServicesRequest(String AuthorizedName, String IDNumber, String RegionName, String OTP, String InvalidOTP) throws InterruptedException {
			Assert.assertTrue(RequestTitle.getText().contains("تفويض خدمات البلدية"));
			//fill Data
			...
			Assert.assertTrue(RequestTitle.getText().contains("تفاصيل تفويض خدمات البلدية"));
		...
		public void CreateEmptyMunicipalityServicesRequest (String AuthorizedName, String IDNumber, String RegionName) throws InterruptedException {
			Assert.assertTrue(RequestTitle.getText().contains("تفويض خدمات البلدية"));
			Thread.sleep(1000);
			...
			Assert.assertTrue(AuthorizedNameErrorMsg.getText().contains("اسم المفوض مطلوب"));
			System.out.println(IDNumErrorMsg.getText());
			Assert.assertTrue(IDNumErrorMsg.getText().contains("رقم الهوية الوطنية مطلوب"));
			System.out.println(RegionNameErrorMsg.getText());
			Assert.assertTrue(RegionNameErrorMsg.getText().contains("إسم المنطقة مطلوب"));
			System.out.println(AuthEndDateErrorMsg.getText());
			Assert.assertTrue(AuthEndDateErrorMsg.getText().contains("تاريخ إنتهاء التفويض مطلوب"));
			Thread.sleep(1000);
			//fill Data
			setTextElementText(AuthorizedNameTxt, AuthorizedName);
			setTextElementText(IDNumberTxt, IDNumber);
