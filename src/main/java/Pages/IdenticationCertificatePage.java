...
public class IdenticationCertificatePage extends PageBase{

	public IdenticationCertificatePage(WebDriver driver) {
		super(driver);
	...
	public void createNewRequest_IdCertificate(String managerName, String sirName, String idNumber, String otp) throws InterruptedException {

		setTextElementText(ManagerNameTXT, managerName);
		Thread.sleep(1000);
		setTextElementText(MRNameTXT, sirName);
		Thread.sleep(1000);
	...
	public void createNewRequest_IdCertificateWithoutData() throws InterruptedException {
